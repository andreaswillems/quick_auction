...
config :frontend,
  admin_user: System.get_env("ADMIN_USER") || raise("environment variable ADMIN_USER is missing")

config :frontend,
  admin_pass: System.get_env("ADMIN_PASS") || raise("environment variable ADMIN_PASS is missing")
...
if config_env() == :prod do
  ...
  config :frontend, QuickAuction.FrontendWeb.Endpoint,
    ...
    check_origin: ["//andreaswillems.dev", "//quickauction.andreaswillems.dev"]
