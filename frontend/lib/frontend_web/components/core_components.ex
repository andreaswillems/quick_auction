defmodule QuickAuction.FrontendWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(QuickAuction.FrontendWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(QuickAuction.FrontendWeb.Gettext, "errors", msg, opts)
    # end
